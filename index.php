...
User-Agent: Instagram 119.0.0.39.198 Android (24/5.0; 515dpi; 1440x2416; huawei/google; Nexus 6P; angler; angler; en_US)
...
class ig {
	...
	public function __construct($settings){
		...
		$this->account['useragent'] = 'Instagram 119.0.0.39.198 Android (24/5.0; 515dpi; 1440x2416; huawei/google; Nexus 6P; angler; angler; en_US)';
	...
	private function request($path,$account = 0,$post = 0,$datas = 0,$returnHeaders = 0){
	  ...
	  if($account == 0){
	  	curl_setopt($ch, CURLOPT_HTTPHEADER, array(
		     ...
		     "Cookie: mid=YWGXkgALAAHzw0LS4i5APvKOn0d4",
		     'Connection: keep-alive'
		  ));
	  } elseif($account == 1){
	  	curl_setopt($ch, CURLOPT_HTTPHEADER, array(

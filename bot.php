                  ...
                  'reply_markup'=>json_encode([
					...
					$bot->sendphoto([
							...
							'photo'=> "https://telegra.ph/file/ce1a4b1af1f6ae8326628.jpg",
							 'caption'=>'البوت مدفوع حمبي💲 و ليس مجاني 👁‍🗨
لشراء نسخه مراسلةة المطور 👁‍🗨 مقابل اي شي',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/W_2_X']],
                       [['text'=>"▪️| قناه المطور", 'url'=>"t.me/iatool"]],
                      ]
                  ])
              ]);   
				}
          ...
          if($data == 'login'){
        		...
        		$keyboard = ['inline_keyboard'=>[
		              ...
		              $bot->sendMessage([
		                  'chat_id'=>$chatId,
		                  'message_id'=>$mid,
		                   'text'=>"هلو گلبي ✔️ في الاسفل هي حساباتك الوهميه المسجله في الاداة",
		                  'reply_markup'=>json_encode($keyboard)
		              ]);
          } elseif($data == 'addL'){
            ...
            $keyboard = [];
             foreach ($accounts as $account => $v) {
              ...
              $bot->answerCallbackQuery([
							'callback_query_id'=>$update->callback_query->id,
							'text'=>"هوه غير يخلـي حسـاب وهـمي حتـه اشتغـل 😑",
							'show_alert'=>1
						]);
            }
